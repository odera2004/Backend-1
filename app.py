...
CORS(app)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://automation_lufs_user:UNmQ3zQQF64sQQpNPb5ToojBDQMmZ8T9@dpg-cv48pkt6l47c738d66ig-a.oregon-postgres.render.com/automation_lufs'
